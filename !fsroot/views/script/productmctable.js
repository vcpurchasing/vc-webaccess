function dbl(a,b){
    ...
    window.opener.document.getElementById('customercode').value = document.getElementById(b).nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.innerText
    window.opener.document.getElementById('customername').value = document.getElementById(b).nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.nextElementSibling.innerText
    window.close();
}
